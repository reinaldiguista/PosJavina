...
@section('breadcrumb')
    @parent
    <li class="active">Tabel Limit harga</li>
@endsection
    ...
    <div class="col-lg-12">
        <div class="box">
            <div class="box-header with-border">
                <button onclick="addForm('{{ route('price_rules.store') }}')" class="btn btn-success btn-lg btn-block"><i class="fa fa-plus-circle"></i> Tambah</button>
                <br>
                <a href="{{ route('export_excel.export_price_rules') }}" class="btn btn-success">EXPORT</a>
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-sm" role="document">
          <div class="modal-content">
            ...
            <form action="{{ route('export_excel.import_price_rules') }}" method="post" enctype="multipart/form-data">
...
@includeIf('price_rules.form')
@includeIf('price_rules.edit')
    ...
    function editForm(url) {
        ...
        $.get(url)
            .done((response) => {
                ...
                $('#modal-edit [name=kategori_produk]').val(response.kategori_produk);
                $('#modal-edit [name=limit_1]').val(response.limit_1);
                $('#modal-edit [name=limit_2]').val(response.limit_2);
            })
            .fail((errors) => {
                alert('Tidak dapat menampilkan data');
                return;
