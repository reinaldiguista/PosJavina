<div class="modal fade" id="modal-form_day_order" tabindex="-1" role="dialog" aria-labelledby="modal-form_day_order">
    <div class="modal-dialog modal-sm" role="document">
        <form action="{{ route('laporan.day_order') }}" method="get" data-toggle="validator" class="form-horizontal">
