<div class="modal fade" id="modal-form_day_cart" tabindex="-1" role="dialog" aria-labelledby="modal-form_day_cart">
    <div class="modal-dialog modal-sm" role="document">
        <form action="{{ route('laporan.day_cart') }}" method="get" data-toggle="validator" class="form-horizontal">
