        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form method="POST" class="form-produk">
                    ...
                    <input type="hidden" name="nomor_nota" id="nomor_nota" value="{{ $nomornota }}">
...
<script>
    ...
    $(function () {
        table = $('.table-cart').DataTable({
            ...
            autoWidth: true,
            ajax: {
                url: '{{ route('cart.edit_data', $nomornota) }}',
            },
            columns: [
    ...
    function tambahProduk(id) {
        ...
        console.log('nomor_nota', nomor_nota);

            $.post(`{{ url('/cart/edit_addProduct') }}/${id_produk}/${count}/${nomor_nota}/${customer_id}`, {
                    '_token': $('[name=csrf-token]').attr('content'),
                    '_method': 'post',
                })
                .done(response => {
