            ...
            <div class="box-header with-border">
                ...
                <div class="form-group row">
                    <label for="position-option" class="col-lg-1 control-label">Nama</label>
                        ...
                        <div class="col-lg-2">
                            <a href="{{ route('cart.create', 0) }}" onclick="cek_session()" class="btn btn-success btn-s" id="session" name="session">
                ...
                <div>
                    <a href="{{ route('cart.transaction_detail') }}" onclick="transaction('{{ route('cart.transaction') }}')" class="btn btn-info btn-lg btn-block" id="transaction" name="transaction">
                        <i class="fa fa-plus-circle"></i> Proses Transksi
                    </a>
                    {{-- {{ route('cart.create', 0) }} <a onclick="transaction('{{ route('cart.transaction') }}')" class="btn btn-info btn-lg btn-block" id="transaction" name="transaction">
