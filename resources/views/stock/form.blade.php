        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row" id="stok_in" name="stok_in" style="display: none">
                    ...
                    <div class="form-group row" id="stok_out" name="stok_out" style="display: none">
                    ...
                    <div class="form-group row" id="lainnya" name="lainnya" style="display: none">
